                    ...
                    selectBtn
                        ...
                        <>
                            ...
                            <Text color={'gray.500'} maxW={'3xl'}>
                                Resume Crafty tools that assemble well-formatted resume. Through a resume crafty, you can create a professional-looking resume in a few easy steps. This resume crafty offer different template options, so you can select the template that best fits your needs and style.
                            </Text>
                            ...
                            <Flex _dark={{ color: 'gray.50' }} textAlign={'start'} flexDirection={'column'} w={'full'}>
                                ...
                                <Box className='Bullet_Points'>
                                    <Button>2</Button>
                                    <Text _dark={{ color: "gray.400" }} color={'gray.900'} fontSize={'xl'}>
                                        Build you resume using our easy to use resume crafty.
                                    </Text>
                                </Box>
                                <Box className='Bullet_Points'>
                                    <Button>3</Button>
